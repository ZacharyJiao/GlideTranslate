...
enum LocalizationInventory {
    ...
    static let dynamicKeys: [String] = [
        ...
        "error.settings.credentialRejected.message",
        "error.settings.credentialRejected.nextAction",
        "error.settings.destinationConfirmationRequired.message",
        "error.settings.destinationConfirmationRequired.nextAction",
        ...
        "error.settings.missingModel.message",
        "error.settings.missingModel.nextAction",
        ...
        "error.settings.providerFailure.message",
        "error.settings.providerFailure.nextAction",
        ...
        "general.defaultProvider.details",
        "general.defaultProvider.destination",
        "general.defaultProvider.none.explanation",
        "locality.cloud", "locality.local", "locality.network", "locality.unresolved",
        "manual.provider.default", "manual.provider.defaultRoute", "manual.provider.model",
        "manual.provider.override", "manual.provider.override.explanation",
        "manual.validation.empty", "manual.validation.missingSelection",
        ...
        "models.credential.missing", "models.credential.new",
        "models.credential.new.explanation", "models.credential.present",
        "models.credential.preserve", "models.credential.remove", "models.credential.replace",
        "models.default", "models.provider.readiness", "models.setAsDefault",
        "menu.provider.automatic", "menu.provider.credential", "menu.provider.model",
        ...
        "provider.readiness.ready", "provider.readiness.missingModel",
        "provider.readiness.destinationConfirmationRequired",
        "provider.readiness.credentialRejected", "provider.readiness.providerFailure",
