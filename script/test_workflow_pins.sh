...
rg -Fq 'XCODE_UNIT_FAILURE_SUMMARY_TESTS|XCODE_UNIT_TESTS|XCODE_UI_TESTS' "$current_workflow"
rg -Fq 'RELEASE_PAYLOAD_AUDIT_TESTS|XCODE_UNIT_FAILURE_SUMMARY_TESTS|XCODE_UNIT_TESTS|XCODE_UI_TESTS' "$current_workflow"
...
rg -Fq 'unit_result_bundle="$RUNNER_TEMP/glidetranslate-unit-tests.private.xcresult"' "$current_workflow"
rg -Fq 'GT_XCODE_UNIT_RESULT_BUNDLE="$unit_result_bundle"' "$current_workflow"
rg -Fq './script/summarize_xcode_unit_failure.sh' "$current_workflow"
rg -Fq 'XCODE_UNIT_FAILURE_SUMMARY:UNVERIFIABLE' "$current_workflow"
rg -Fq '/bin/rm -rf "$unit_result_bundle"' "$current_workflow"
